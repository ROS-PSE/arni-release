Name:           ros-indigo-arni-nodeinterface
Version:        1.1.2
Release:        1%{?dist}
Summary:        ROS arni_nodeinterface package
...
%description
The ARNI host manager, which collects host/node statistics and enables the ARNI
countermeasure node to run remote commands.
